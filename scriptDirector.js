/////////////////////////////////////////////////////////הזדהות בשם משתמש וסיסמא לעמוד מנהל
var user1 = "avi";
...
class Director {
  ...
  addNewProdactToShop(id, name, model, img, price) {
    ...
    if (id_available == true) {
      let x = new Prodact(id, name, model, img, price);
...
///////////////////////////////////////////////כפתור מנהל הוספת פריט לחנות

document
  .getElementById("btnDirectorAddNewProdact")
  .addEventListener("click", () => {
    let idDirector = document.getElementById("idDirector");
    let nameProdactDirector = document.getElementById("nameProdactDirector");
    let modelProdactDirector = document.getElementById("modelProdactDirector");
    let priceProdactDirector = document.getElementById("priceProdactDirector");
    let imgProdactDirector = document.getElementById("imgProdactDirector");
    director1.addNewProdactToShop(
      idDirector.valueAsNumber,
      nameProdactDirector.value,
      modelProdactDirector.value,
      priceProdactDirector.valueAsNumber,
      imgProdactDirector.value
    );
  });
//////////////////////////////////////////////////////////////כפתור מנהל הסרת פריט מחנות
let sn_delete_director = document.getElementById("sn_delete_director");
document.getElementById("btn_delete_director").addEventListener("click", () => {
  director1.deleteProdactFromShop(sn_delete_director.value);
});
///////////////////////////////////////////////////////כפתור מנהל עדכון מחיר למוצר
let sn_update_price_director = document.getElementById(
  "sn_update_price_director"
);
let newPrice = document.getElementById("newPrice");
document
  .getElementById("btn_update_price_director")
  .addEventListener("click", () => {
    director1.updatePriceProdact(
      sn_update_price_director.value,
      newPrice.value
    );
  });
//////////////////////////////////check
